            ...
            var canvas = new Canvas(size[0], size[1]),
                ...
                options = {
                    ...
                    position     : {
                        ...
                        skills        : data.required_skills.map(function (s) {
                            return { name: s.name, required: true };
                        })
                        .concat(data.bonus_skills.map(function (s) {
                            return { name: s.name, required: false };
                        }))
                        .slice(0, 5),
                        place_of_work : data.place_of_work.name,
                        contract_type : data.contract_type.name,
