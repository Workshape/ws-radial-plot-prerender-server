 ...
 * @param {[Array]} sets
 */
module.exports = function (ctx, size, center, sets, showLabels, shapeColors) {
    var stageSize = size,
    ...
    shapeColors = shapeColors ? shapeColors.split('|') : colors.SHAPE;
    ...
    function draw() {
        ...
        drawShape(sets[0], shapeColors[0], true);
